...
/** @type {string} */
const CACHE_VERSION = '1765102585|49372017487';
/** @type {string} */
const CACHE_PREFIX = 'DogRunner-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'DogRunner.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["DogRunner.html","DogRunner.js","DogRunner.offline.html","DogRunner.icon.png","DogRunner.apple-touch-icon.png","DogRunner.audio.worklet.js","DogRunner.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["DogRunner.wasm","DogRunner.pck"];
